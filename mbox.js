...
if (typeof mboxVersion == 'undefined') {
  ...
  var mboxFactoryDefault = new mboxFactory('dayintegrationintern.tt.omtrdc.net', 'dayintegrationintern',
    'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
  ...
  document.write('<' + 'scr' + 'ipt language="Javascript1.2" src='
    + '"//admin4.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=dayintegrationintern.tt.omtrdc.net'
    + '&clientCode=dayintegrationintern"><' + '\/scr' + 'ipt>');
};
...
mboxVizTargetUrl = function(_mboxName /*, ... */) {
  ...
  _urlBuilder.setBasePath('/m2/' + 'dayintegrationintern' + '/viztarget');
